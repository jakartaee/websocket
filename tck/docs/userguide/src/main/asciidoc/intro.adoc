...
and indexed within the TCK test directory structure.
...
[start=2]
.  Set up the {TechnologyShortName} TCK software. +
See link:config.html#GBFVV[Chapter 4, "Setup and Configuration,"] for
details about the following steps.
[loweralpha]
..  Set up your shell environment.
.  Test the {TechnologyShortName} {TechnologyVersion} implementation. +
