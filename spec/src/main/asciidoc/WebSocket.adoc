...
listed in preference order from most preferred to least preferred. The server
should include its preferred configuration in the opening handshake response.
If none of the requested configurations are acceptable, the extension is not
included in the opening handshake response [WSC-3.1.3-1].
